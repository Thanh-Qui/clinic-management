...
<div class="main-content">
    <div class="wrapper">
        <h3 class="pt-2 pl-20">BÁO CÁO DOANH THU</h3>
        ...
        <table class="table table-hover table-list table-bordered">
            ...
            if (isset($_GET['report_number'])) {
                ...
                <tbody>
                    <td><?= $sn++; ?></td>
                    <td><?= $dateNow; ?></td>
                    <td><?php if($rowDatePart == "") {echo "";} else {echo $total;} ?></td>
                    <td style="text-align: center;">
                        <a href="<?php echo SITEURL; ?>admin/report/view-revenue.php?date=<?= $dateNow; ?>&report_number=<?= $formDate; ?>"><i class="fa-solid fa-eye" style="margin-top: 5px;"></i></a>
                    </td>
                </tbody>
                <?php
